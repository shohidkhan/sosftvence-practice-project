...
<section class="overview-cards-wrapper">
  <div class="overview-card">
    <h3 class="overview-card-title">Total Users</h3>
    <div class="overview-card-content">
      <p class="overview-card-amount">3</p>
  ...
  <div class="overview-card">
    <h3 class="overview-card-title">Total Income</h3>
    <div class="overview-card-content">
  ...
  <div class="overview-card">
    <h3 class="overview-card-title">To Signage Owner</h3>
    <div class="overview-card-content">
      <p class="overview-card-amount">SR 2000</p>
  ...
  <div class="overview-card">
    <h3 class="overview-card-title">Profit</h3>
    <div class="overview-card-content">
      <p class="overview-card-amount">SR 2000</p>
...
<section class="overview-status-wrapper">
  <div class="overview-status-card">
    <div class="status-text">Signage status</div>

    <div class="status-wrapper">
      <div class="status-container">
        <h4 class="status-title">Total Registrared signages</h4>
        <p class="status-amount">500</p>
        <p class="progress">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_751_3405)">
                <path
                  d="M15.3307 4L8.9974 10.3333L5.66406 7L0.664062 12"
                  stroke="#34B26F"
                  stroke-width="2"
      ...
      <div class="status-container">
        <h4 class="status-title">Total Owners</h4>
        <p class="status-amount">50</p>
      </div>
      <div class="status-container">
        <h4 class="status-title">Total Active Signages</h4>
        <p class="status-amount">24</p>
      </div>
      <div class="status-container">
        <h4 class="status-title">Total Active Days</h4>
        <p class="status-amount">17</p>
      </div>
      <div class="status-container">
        <h4 class="status-title">Total Active Owners</h4>
        <p class="status-amount">8</p>
      </div>
    </div>
  </div>

  <div class="overview-card">
    <h3 class="overview-card-title">Page Visits</h3>
    <div class="overview-card-content">
      <div>
        <p class="overview-card-amount">43k</p>
        <p class="progress">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    <table class="signage-table">
      ...
      <tbody>
        <tr>
            ...
            <div class="user-card">
              <div class="user-info">
                ...
                <div class="user-details">
                  <h3 class="user-name">Arvid Lars</h3>
                  <p class="user-date">25 December 2024</p>
                </div>
              </div>
              <div class="user-stats">
                <p class="user-price">4000 SAR</p>
                <p class="user-id">#T3NQ5D9JX</p>
              </div>
            </div>
          </td>
          <td>
          ...
          <td><span class="profile-bold">400 SAR</span></td>
        </tr>
        <tr>
          <td>
            <div class="user-card">
