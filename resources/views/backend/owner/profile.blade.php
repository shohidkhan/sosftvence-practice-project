...
<section class="get-started">
    <div class="get-started-form-wrapper">
      ...
      <form class="get-started-form" method="POST" action="{{ route('owner.profile-store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="input-wrapper-large">
          ...
          <input type="tel"  name="company_phone" value="{{ old('company_phone',$userProfile->company_phone ?? '') }}" placeholder="+898-2786223" class="text-end"/>
          @error('company_phone')
              <span class="text-danger">{{ $message }}</span>
          @enderror
        </div>
       ...
       @if (auth()->user()->user_type=='owner')
        ...
        <div class="input-wrapper-large">
            ...
            <div class="upload-box">
              <input type="file" name="al_document"  id="file-input" />
              <div class="upload-content">
                <span class="upload-icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
